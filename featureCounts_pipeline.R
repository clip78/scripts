...
fc <- featureCounts(files=files,isPairedEnd=TRUE,annot.ext="/media/HD-LBU3/Clay/genome/Caenorhabditis_elegans/UCSC/ce10/Annotation/Genes/genes.gtf",isGTFAnnotationFile=TRUE,GTF.featureType="exon")
